...
verify "pact-variety.md" "Variety (lines 766-855)" "766,855"

# Combined-range extracts
verify "pact-s2-coordination.md" "S2 Coordination (lines 485-645 + 1156-1171)" "485,645" "1156,1171"
verify "pact-workflows.md" "Workflows (lines 856-1018)" "856,1018"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1030-1154)" "1030,1154"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1019-1029 + 1172-1251)" "1019,1029" "1172,1251"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1277-1308)" "1277,1308"
verify "pact-completeness.md" "Completeness Signals (lines 1310-1348)" "1310,1348"
verify "pact-scope-detection.md" "Scope Detection (lines 1350-1484)" "1350,1484"
verify "pact-scope-contract.md" "Scope Contract (lines 1486-1644)" "1486,1644"
verify "pact-scope-phases.md" "Scoped Phases (lines 1646-1729)" "1646,1729"
