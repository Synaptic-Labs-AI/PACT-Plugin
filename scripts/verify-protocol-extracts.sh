...
verify "pact-variety.md" "Variety (lines 765-854)" "765,854"

# Combined-range extracts
verify "pact-s2-coordination.md" "S2 Coordination (lines 485-644 + 1155-1170)" "485,644" "1155,1170"
verify "pact-workflows.md" "Workflows (lines 855-1017)" "855,1017"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1029-1153)" "1029,1153"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1018-1028 + 1171-1250)" "1018,1028" "1171,1250"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1276-1307)" "1276,1307"
verify "pact-completeness.md" "Completeness Signals (lines 1309-1347)" "1309,1347"
verify "pact-scope-detection.md" "Scope Detection (lines 1349-1483)" "1349,1483"
verify "pact-scope-contract.md" "Scope Contract (lines 1485-1643)" "1485,1643"
verify "pact-scope-phases.md" "Scoped Phases (lines 1645-1726)" "1645,1726"
