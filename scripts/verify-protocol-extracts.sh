...
verify "pact-s2-coordination.md" "S2 Coordination (lines 423-593 + 1221-1234)" "423,593" "1221,1234"
verify "pact-workflows.md" "Workflows (lines 917-1079)" "917,1079"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1094-1219)" "1094,1219"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1081-1092 + 1236-1272)" "1081,1092" "1236,1272"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1274-1307)" "1274,1307"
verify "pact-completeness.md" "Completeness Signals (lines 1309-1347)" "1309,1347"
verify "pact-scope-detection.md" "Scope Detection (lines 1349-1451)" "1349,1451"
verify "pact-scope-contract.md" "Scope Contract (lines 1453-1567)" "1453,1567"
verify "pact-scope-phases.md" "Scoped Phases (lines 1569-1650)" "1569,1650"
verify "pact-audit.md" "Concurrent Audit (lines 1652-1787)" "1652,1787"
verify "pact-self-repair.md" "Self-Repair (lines 1789-1856)" "1789,1856"
verify "pact-channel-capacity.md" "Channel Capacity (lines 1858-1937)" "1858,1937"
