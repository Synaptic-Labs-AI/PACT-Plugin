...
verify "pact-s1-autonomy.md" "S1 Autonomy (lines 641-714)" "641,714"
verify "pact-variety.md" "Variety (lines 760-849)" "760,849"

# Combined-range extracts
verify "pact-s2-coordination.md" "S2 Coordination (lines 485-639 + 1150-1165)" "485,639" "1150,1165"
verify "pact-workflows.md" "Workflows (lines 850-1012)" "850,1012"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1024-1148)" "1024,1148"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1013-1023 + 1166-1245)" "1013,1023" "1166,1245"
verify "pact-documentation.md" "Documentation (lines 1246-1270)" "1246,1270"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1271-1302)" "1271,1302"
verify "pact-completeness.md" "Completeness Signals (lines 1304-1342)" "1304,1342"
verify "pact-scope-detection.md" "Scope Detection (lines 1344-1475)" "1344,1475"
verify "pact-scope-contract.md" "Scope Contract (lines 1477-1633)" "1477,1633"
verify "pact-scope-phases.md" "Scoped Phases (lines 1635-1710)" "1635,1710"
