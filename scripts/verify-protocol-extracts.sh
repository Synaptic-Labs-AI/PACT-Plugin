...
verify "pact-variety.md" "Variety (lines 645-706)" "645,706"

# Combined-range extracts
verify "pact-s2-coordination.md" "S2 Coordination (lines 365-525 + 995-1009)" "365,525" "995,1009"
verify "pact-workflows.md" "Workflows (lines 707-856)" "707,856"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 868-992)" "868,992"
verify "pact-phase-transitions.md" "Phase Transitions (lines 857-867 + 1010-1087)" "857,867" "1010,1087"
verify "pact-documentation.md" "Documentation (lines 1088-1112)" "1088,1112"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1113-1142)" "1113,1142"
verify "pact-completeness.md" "Completeness Signals (lines 1144-1180)" "1144,1180"
verify "pact-scope-detection.md" "Scope Detection (lines 1182-1313)" "1182,1313"
verify "pact-scope-contract.md" "Scope Contract (lines 1315-1471)" "1315,1471"
verify "pact-scope-phases.md" "Scoped Phases (lines 1473-1548)" "1473,1548"
