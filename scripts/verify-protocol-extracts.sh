...
verify "pact-s2-coordination.md" "S2 Coordination (lines 484-638 + 1149-1164)" "484,638" "1149,1164"
verify "pact-workflows.md" "Workflows (lines 849-1011)" "849,1011"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1023-1147)" "1023,1147"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1012-1022 + 1165-1244)" "1012,1022" "1165,1244"
verify "pact-documentation.md" "Documentation (lines 1245-1269)" "1245,1269"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1270-1301)" "1270,1301"
verify "pact-completeness.md" "Completeness Signals (lines 1303-1341)" "1303,1341"
verify "pact-scope-detection.md" "Scope Detection (lines 1343-1474)" "1343,1474"
verify "pact-scope-contract.md" "Scope Contract (lines 1476-1632)" "1476,1632"
verify "pact-scope-phases.md" "Scoped Phases (lines 1634-1709)" "1634,1709"
