...
verify "pact-s2-coordination.md" "S2 Coordination (lines 365-525 + 991-1005)" "365,525" "991,1005"
verify "pact-workflows.md" "Workflows (lines 706-848)" "706,848"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 863-988)" "863,988"
verify "pact-phase-transitions.md" "Phase Transitions (lines 849-862 + 1006-1083)" "849,862" "1006,1083"
verify "pact-documentation.md" "Documentation (lines 1084-1108)" "1084,1108"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1109-1140)" "1109,1140"
verify "pact-completeness.md" "Completeness Signals (lines 1142-1176)" "1142,1176"
verify "pact-scope-detection.md" "Scope Detection (lines 1178-1309)" "1178,1309"
verify "pact-scope-contract.md" "Scope Contract (lines 1311-1463)" "1311,1463"
verify "pact-scope-verification.md" "Scope Verification (lines 1465-1553)" "1465,1553"
