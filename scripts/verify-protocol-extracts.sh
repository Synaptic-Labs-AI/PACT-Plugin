...
verify "pact-s2-coordination.md" "S2 Coordination (lines 365-525 + 988-1002)" "365,525" "988,1002"
verify "pact-workflows.md" "Workflows (lines 706-849)" "706,849"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 861-985)" "861,985"
verify "pact-phase-transitions.md" "Phase Transitions (lines 850-860 + 1003-1080)" "850,860" "1003,1080"
verify "pact-documentation.md" "Documentation (lines 1081-1105)" "1081,1105"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1106-1137)" "1106,1137"
verify "pact-completeness.md" "Completeness Signals (lines 1139-1173)" "1139,1173"
verify "pact-scope-detection.md" "Scope Detection (lines 1175-1306)" "1175,1306"
verify "pact-scope-contract.md" "Scope Contract (lines 1308-1464)" "1308,1464"
verify "pact-scope-phases.md" "Scoped Phases (lines 1466-1541)" "1466,1541"
