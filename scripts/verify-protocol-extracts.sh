...
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1274-1305)" "1274,1305"
verify "pact-completeness.md" "Completeness Signals (lines 1307-1345)" "1307,1345"
verify "pact-scope-detection.md" "Scope Detection (lines 1347-1449)" "1347,1449"
verify "pact-scope-contract.md" "Scope Contract (lines 1451-1565)" "1451,1565"
verify "pact-scope-phases.md" "Scoped Phases (lines 1567-1648)" "1567,1648"
verify "pact-audit.md" "Concurrent Audit (lines 1650-1785)" "1650,1785"
verify "pact-self-repair.md" "Self-Repair (lines 1787-1854)" "1787,1854"
verify "pact-channel-capacity.md" "Channel Capacity (lines 1856-1935)" "1856,1935"
