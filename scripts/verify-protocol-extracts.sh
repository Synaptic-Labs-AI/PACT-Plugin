...
verify "pact-s2-coordination.md" "S2 Coordination (lines 423-593 + 1229-1242)" "423,593" "1229,1242"
verify "pact-workflows.md" "Workflows (lines 917-1087)" "917,1087"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 1102-1227)" "1102,1227"
verify "pact-phase-transitions.md" "Phase Transitions (lines 1089-1100 + 1244-1280)" "1089,1100" "1244,1280"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1282-1315)" "1282,1315"
verify "pact-completeness.md" "Completeness Signals (lines 1317-1355)" "1317,1355"
