...
verify "pact-s5-policy.md" "S5 Policy (lines 13-153)" "13,153"
verify "pact-s4-checkpoints.md" "S4 Checkpoints (lines 155-234)" "155,234"
verify "pact-s4-environment.md" "S4 Environment (lines 236-308)" "236,308"
verify "pact-s4-tension.md" "S4 Tension (lines 310-373)" "310,373"
verify "pact-ct-teachback.md" "CT Teachback (lines 375-480)" "375,480"
...
verify "pact-scope-phases.md" "Scoped Phases (lines 1592-1667)" "1592,1667"
