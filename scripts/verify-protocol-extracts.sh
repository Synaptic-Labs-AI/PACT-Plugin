...
verify "pact-s2-coordination.md" "S2 Coordination (lines 365-525 + 983-997)" "365,525" "983,997"
verify "pact-workflows.md" "Workflows (lines 706-848)" "706,848"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 860-980)" "860,980"
verify "pact-phase-transitions.md" "Phase Transitions (lines 849-859 + 998-1075)" "849,859" "998,1075"
