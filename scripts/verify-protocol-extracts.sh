...
verify "pact-s2-coordination.md" "S2 Coordination (lines 398-539 + 1065-1078)" "398,539" "1065,1078"
verify "pact-workflows.md" "Workflows (lines 753-926)" "753,926"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 938-1063)" "938,1063"
verify "pact-phase-transitions.md" "Phase Transitions (lines 927-936 + 1080-1116)" "927,936" "1080,1116"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1118-1149)" "1118,1149"
verify "pact-completeness.md" "Completeness Signals (lines 1151-1189)" "1151,1189"
verify "pact-scope-detection.md" "Scope Detection (lines 1191-1293)" "1191,1293"
verify "pact-scope-contract.md" "Scope Contract (lines 1295-1409)" "1295,1409"
verify "pact-scope-phases.md" "Scoped Phases (lines 1411-1492)" "1411,1492"
verify "pact-audit.md" "Concurrent Audit (lines 1494-1631)" "1494,1631"
