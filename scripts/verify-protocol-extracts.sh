...
verify "pact-agent-stall.md" "Teammate Stall Detection (lines 1105-1135)" "1105,1135"
verify "pact-completeness.md" "Completeness Signals (lines 1137-1171)" "1137,1171"
verify "pact-scope-detection.md" "Scope Detection (lines 1173-1304)" "1173,1304"
verify "pact-scope-contract.md" "Scope Contract (lines 1306-1454)" "1306,1454"
verify "pact-scope-phases.md" "Scoped Phases (lines 1456-1542)" "1456,1542"
