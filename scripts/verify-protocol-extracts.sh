...
verify "pact-phase-transitions.md" "Phase Transitions (lines 850-860 + 1003-1082)" "850,860" "1003,1082"
verify "pact-documentation.md" "Documentation (lines 1083-1107)" "1083,1107"
verify "pact-agent-stall.md" "Agent Stall Detection (lines 1108-1139)" "1108,1139"
verify "pact-completeness.md" "Completeness Signals (lines 1141-1175)" "1141,1175"
verify "pact-scope-detection.md" "Scope Detection (lines 1177-1308)" "1177,1308"
verify "pact-scope-contract.md" "Scope Contract (lines 1310-1466)" "1310,1466"
verify "pact-scope-phases.md" "Scoped Phases (lines 1468-1543)" "1468,1543"
