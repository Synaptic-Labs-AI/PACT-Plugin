...
@pytest.fixture
def orchestrate_with_teams_transcript() -> str:
    """Fixture returning an orchestrate transcript using Agent Teams (v3)."""
    return create_orchestrate_with_teams_transcript(
        phase="code",
