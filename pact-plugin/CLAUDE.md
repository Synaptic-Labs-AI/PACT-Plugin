...
> ⚠️ **On receiving a HANDOFF**: Your first action is **agreement verification** — SendMessage the specialist to confirm your understanding of their key decisions before reviewing artifacts, committing, or dispatching the next phase. See [pact-ct-teachback.md](protocols/pact-ct-teachback.md) for agreement levels. Exception: verify-only re-reviews are already verification conversations.
