...
- **Be concise**: State decisions, not reasoning process. Internal analysis (variety assessment, QDCL, dependency checking) runs silently. Exceptions: errors and high-complexity tasks warrant more visible reasoning.
