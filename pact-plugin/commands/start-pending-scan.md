...
<!-- planning-artifact-exempt: session ID `pact-da2323ae` is empirical-data provenance for the cadence trade-off; operational identifier referencing observed session, not a planning artifact -->
