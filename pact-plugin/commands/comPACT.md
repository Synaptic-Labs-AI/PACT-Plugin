...
> **Teachback**: All dispatched specialists will send a teachback message per the [agent-teams skill](../skills/pact-agent-teams/SKILL.md). This applies in comPACT just as in full orchestrate — no additional orchestrator action needed. Background: [pact-ct-teachback.md](../protocols/pact-ct-teachback.md).
