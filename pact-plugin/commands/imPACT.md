...
**Reset**: `TaskUpdate(featureTaskId, metadata={"impact_cycle_count": 0})` when the current blocker is resolved (prevents inherited count from triggering premature META-BLOCK ALERT on unrelated blockers).
